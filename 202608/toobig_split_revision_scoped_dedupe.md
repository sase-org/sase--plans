...
- **COMMITS:**
  ...
  - [47b2123](https://github.com/sase-org/sase/commit/47b212379adac5cfa21cf3e4ddf0ba1fbf156e6f)
    — test(finalizers): split commit reconciliation tests under 500 lines
  - [485e798](https://github.com/sase-org/sase/commit/485e7985b0a4c76cff5f49aa02f07f681ffda7ac)
    — test(finalizers): split live e2e suite under 500 lines
  - [1e40ed1](https://github.com/sase-org/sase/commit/1e40ed159bff60336a2145153a145a34be30756b)
    — test(finalizers): split protocol harness into topic files
  - [9615cd6](https://github.com/sase-org/sase/commit/9615cd6394317eec05d3a3033758daf9893f9d02)
    — test: split plan-approval launch reliability suite under 500 lines
