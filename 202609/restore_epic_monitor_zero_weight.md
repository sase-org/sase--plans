...
- **COMMITS:**
  - [3f1ca28](https://github.com/sase-org/sase-core/commit/3f1ca286e53b7e702c92f8a9662dcd77c3777e9d)
    — fix(fleet_contract): accept explicit zero queue weight in scan and validation
