...
- **AGENTS:**
  ...
  - [bbugyi200.athena.sase-z4.3](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-z4.3/README.md)
  - [bbugyi200.athena.sase-z4.4](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-z4.4/README.md)
  - [bbugyi200.athena.toobig-53.artifact_link_event_publisher.0](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.toobig-53.artifact_link_event_publisher.0.md)
  ...
  - [bbugyi200.athena.toobig-53.file_completion_accept.0](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.toobig-53.file_completion_accept.0.md)
  - [bbugyi200.athena.toobig-53.test_ace_png_snapshots_model_completion.0](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.toobig-53.test_ace_png_snapshots_model_completion.0/README.md)
  ...
  - [bbugyi200.athena.toobig-53.test_machine_init.0](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.toobig-53.test_machine_init.0.md)
  - [bbugyi200.athena.toobig-53.trail_chrome.0](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.toobig-53.trail_chrome.0/README.md)
- **COMMITS:**
  ...
  - [71c3df7](https://github.com/sase-org/sase/commit/71c3df748fac1ccf09c3c885474ddbc1f935befe)
    — feat(runner-slots): enforce weighted admission lifecycle
  - [81064c1](https://github.com/sase-org/sase/commit/81064c144a7ef289d0c9080a7565a6f62ecae0f7)
    — feat(tui): show weighted runner capacity
  - [4de32fc](https://github.com/sase-org/sase/commit/4de32fc3c54dc56f71b81ef409491209ecdea1fa)
    — refactor(ace): split file-completion accept mixin into sibling modules
  - [9e0222c](https://github.com/sase-org/sase/commit/9e0222c8beac4efe2804acdf5ff189d41cd5cc07)
    — refactor(pager): split trail chrome into sibling modules
  - [59c4d11](https://github.com/sase-org/sase/commit/59c4d118637da36277e96223a9ead3305c84f252)
    — refactor(sdd): split artifact_link_event_publisher under 500-line files
  - [81033f4](https://github.com/sase-org/sase/commit/81033f4de95179ef646f17d902d293eea67f9d1a)
    — refactor(sdd): split artifact-link outbox into sibling modules
  - [eb7560f](https://github.com/sase-org/sase/commit/eb7560fd5e3c6258eb1c9392c914341173f07f7e)
    — test(ace): split model completion PNG snapshots by completion kind
  - [4c2a903](https://github.com/sase-org/sase/commit/4c2a90304438883b6c29aae0cc0b43d949aa6ed3)
    — test(dispatch): split machine-init tests into focused modules
  - [2fd8e9e](https://github.com/sase-org/sase/commit/2fd8e9ee17f77fb8c0bb47c10994ee1e29aa6dce)
    — test(doctor): split provider checks into per-check files
